// Couldn't get it to work with this
// http://electronoobs.com/eng_arduino_tut101.php
...
//Define the used
#define ESP8266_RX 17  //Connect the TX pin from the ESP to this RX pin of the Arduino
#define ESP8266_TX 16  //Connect the TX pin from the Arduino to the RX pin of ESP
...
//////////////////////////////////////////////
const char SSID_ESP[] = "DNA-WLAN-2G-B310";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "97960799949";             //Add the password of that WIFI connection
